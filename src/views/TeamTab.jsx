...
// â”€â”€â”€ Local constants (mirrored from VisitsTab) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const STATUS_CONFIG = {
...
const TYPE_EMOJI = { "Email": "âœ‰ï¸", "Phone Call": "ðŸ“ž", "Meeting": "ðŸ¤", "Exhibition": "ðŸ›ï¸" };
...
// â”€â”€â”€ "This week" helpers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const getWeekRange = () => {
...
// â”€â”€â”€ Detail panel (local copy â€” same as VisitsTab.DetailPanel) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  return (
    <div style={{ marginTop: 8, border: `1px solid ${T.border}`, borderRadius: 10, background: T.bgCard, overflow: "hidden", animation: "fadeIn 0.2s ease" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 16px", borderBottom: `1px solid ${T.border}`, background: T.bgCardAlt }}>
        ...
        <button onClick={onClose} style={{ background: "none", border: "none", cursor: "pointer", fontSize: 16, color: T.textMuted, lineHeight: 1, padding: "2px 6px", fontFamily: "inherit" }}>Ã—</button>
      </div>
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "14px 20px", padding: "14px 16px" }}>
        ...
        {engagement.x_crm_lead_id?.[0] && (
          <div style={{ gridColumn: "1 / -1" }}>
            <a href={`https://crm-adage-6.odoo.com/odoo/crm/${engagement.x_crm_lead_id[0]}`}
...
// â”€â”€â”€ Drill-down pivot card â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function PivotCard({ leads, personRegion, personKeys, allRegions, engagements, userMap }) {
  ...
  // â”€â”€ Level 2: single engagement â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  if (drill.level === 2 && selectedEng) {
    const lead = leadMap[selectedEng.x_crm_lead_id?.[0]];
    const company = lead?.partner_id?.[1] || selectedEng.x_crm_lead_id?.[1] || "â€”";
    return (
  ...
  // â”€â”€ Level 1: person detail grouped by region â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Level 0: summary pivot table â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  return (
    <div className="card" style={{ padding: "20px 22px" }}>
      <div style={{ fontSize: 11, color: T.textMuted, letterSpacing: "0.8px", textTransform: "uppercase", fontWeight: 600, marginBottom: 16 }}>
        Planned visits â€” per person Ã— per region
      </div>
      {personKeys.length > 0 ? (
                  ...
                  <tr key={name}
                    ...
                    <td style={{ padding: "10px 12px", fontSize: 13, color: T.textPrimary }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                        ...
                        <span style={{ fontSize: 10, color: T.textMuted, marginLeft: "auto" }}>â†’</span>
                      </div>
                    </td>
                    {allRegions.map(r => (
    ...
    <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 16, fontSize: 13 }}>
      {segments.map((seg, i) => (
        <span key={i} style={{ display: "flex", alignItems: "center", gap: 6 }}>
          {i > 0 && <span style={{ color: T.textMuted }}>â€º</span>}
          {seg.onClick
...
// â”€â”€â”€ This Week's Planned Activities card â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  return (
    <div className="card" style={{ padding: "20px 22px" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
        ...
        <span style={{ fontSize: 11, color: T.textMuted }}>{monLabel} â€“ {sunLabel}</span>
      </div>

      {groups.length === 0 ? (
        <div style={{ textAlign: "center", padding: "32px 0", color: T.textMuted, fontSize: 13 }}>
          âœ… No activities scheduled for this week.
        </div>
      ) : (
...
function ActivityCard({ eng, lead, cfg, urg, hasFollowUp, isSelected, onClick }) {
  ...
  return (
    ...
    >
      ...
      {/* Status pill */}
      <span style={{ fontSize: 10, fontWeight: 600, padding: "2px 8px", borderRadius: 100, background: cfg.bg, color: cfg.text, flexShrink: 0 }}>{eng.x_studio_engagement_status || "â€”"}</span>
    </div>
  );
}

// â”€â”€â”€ Main TeamTab export â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
